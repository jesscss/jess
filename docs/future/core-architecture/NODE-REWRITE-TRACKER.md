...
- [ ] `Mixin`: direct source syntax/guard writer exists, public
  ...
  `name`/`params`/`guard`. Audit guard/default/body copy interactions and
  callable candidate output.
