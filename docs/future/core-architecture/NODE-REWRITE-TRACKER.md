...
- [ ] `Rules`: direct braced source writer exists and public `toBraced(...)`
  ...
  charset/comment/import hoisting writes detached child syntax directly instead
  of calling public child string wrappers; isolate
