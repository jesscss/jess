...
- [ ] `QueryCondition`: direct condition syntax writer exists, source/static
  ...
  the same direct source syntax contract while subclasses/custom condition
  syntax stay on the fallback readback path, and dynamic render now uses a
