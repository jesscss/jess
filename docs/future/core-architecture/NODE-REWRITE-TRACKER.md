...
- [ ] `Rules`: direct braced source writer exists and public `toBraced(...)`
  ...
  of calling public child string wrappers; Mixin, Func, Collection, If, For,
