...
- [ ] `Interpolated`: direct source writer exists, public `replace(...)` no
  ...
  `PseudoSelector.toTrimmedString(...)`. Cold replacement string assembly,
