...
- [ ] `Ruleset`: source-direct eligibility and bare-ampersand selector-list
  ...
  fallback branch, and trims trailing selector whitespace through the writer
  window instead of regex post-processing the captured selector text.
