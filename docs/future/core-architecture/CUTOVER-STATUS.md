...
- import edge-modes: ~~interpolated-path retry~~ (case A + case B landed — see ✅; `(inline)`-in-deferred-body residual gated, IOU to eliminate at P4), extend-through-import, compose/forward
- ~~reference-mode~~ (extend-into-reference landed — see ✅; rich-reference-body residual gated, IOU to eliminate at P4); value frontier; at-rule-`&`-through-hoist
