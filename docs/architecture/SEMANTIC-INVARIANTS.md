...
[`DESIGN-DECISIONS.md`](../future/core-architecture/DESIGN-DECISIONS.md), and
this checklist tells you when you are obligated to consult or extend it.

> **Path note.** The ledger link above is its location on `dev` today. The
> in-flight `docs-tracking-reconcile` reorg moves it to `./core/DESIGN-DECISIONS.md`;
> update the links in this file when that lands.
...
4. **The cited evidence was deleted too.** The commit's proof was "alpha-oracle
   ...
   [`GOAL1-SCORECARD.md`](../future/core-architecture/GOAL1-SCORECARD.md) now
...
[`DIALECT-ARCHITECTURE-AND-ERROR-COVERAGE.md`](../future/parser-architecture/DIALECT-ARCHITECTURE-AND-ERROR-COVERAGE.md),
...
[`PSEUDO-ARGUMENT-CONSOLIDATION-DESIGN.md`](../future/core-architecture/PSEUDO-ARGUMENT-CONSOLIDATION-DESIGN.md)
