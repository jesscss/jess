...
Grounded in `docs/architecture/core/TREE2-CONSTITUTION.md`. Byte-identity is the FLOOR; every action below is anchored to a constitution principle (P0 keystone = re-derivation from bytes; P1 = kill bridge; P2 = kill verbatim ports; P3 = names; P4 = DRY; P5 = complexity).
