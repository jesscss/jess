...
export interface IParseResult<T extends CssCoreParser = CssCoreParser> {
  cst: CstNode
...
export type CssRules = keyof ConditionalPick<CssCoreParser, () => CstNode>
 ...
 */
export class CssCstParser {
  lexer: Lexer
  /** @todo - return Jess AST as parser */
  parser: CssCoreParser
  ...
  constructor(
    ...
    this.parser = new CssCoreParser(lexer, T as TokenMap, config)
  }
