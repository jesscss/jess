import { mixin, rules, el, decl, any, condition, expr, ref, list, vardecl, Node, call, ruleset, sel, co, compound, interpolated, INTERPOLATION_PLACEHOLDER, amp, paren, dimension, op, quoted, seq, atrule, defaultguard, Rules as RulesClass, comment, Any, Bool, bool, JsFunction, Mixin, nil, type AnyRole } from '../index.js';
