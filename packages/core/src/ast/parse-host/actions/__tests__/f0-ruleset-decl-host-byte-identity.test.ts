...
/**
 * F0 byte-identity: the registry-driven dispatch host
 ...
 * `parseToAst` (the tree2 driver that returns the root directly). This
...
describe('registry host byte-identity vs bridge', () => {
