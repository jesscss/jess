...
/**
 * [tree2-native] F2 byte-identity: the custom-property + merge declaration family
 * produces the SAME serialized CSS as the parse→legacy-tree→bridge path (the
 * oracle), driven through `runFunctionalParseT2`. Covers:
...
describe('[tree2-native] F2 custom-props + merge host byte-identity vs bridge', () => {
