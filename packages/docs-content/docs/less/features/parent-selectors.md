...
slug: "/features/parent-selectors"
audiences:
  - less
origin: less
---
...
The `&` operator represents the parent selectors of a [nested rule](./nested) and is most commonly used when applying a modifying class or pseudo-class to an existing selector:
