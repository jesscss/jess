...
import { functionalIt, trimmedStylesheet } from './parse-helpers.js';
...
describe('scss-parser (ast serialize)', () => {
  functionalIt('serializes a basic ruleset + declaration', () => {
    const { tree, errors, lexerResult } = parser.parse('.a { color: red; }');
    expect(lexerResult.errors).toEqual([]);
    expect(errors).toEqual([]);
    expect(serializeTypes(tree)).toContainString(`(Ruleset`);
    expect(serializeTypes(tree)).toContainString(`(Declaration`);
    expect(serializeTypes(tree)).toContainString(`'color'`);
  });

  functionalIt('serializes Sass map literal as Collection', () => {
  ...
  functionalIt('serializes Sass bracketed list literals as Paren with delimiter metadata', () => {
  ...
  functionalIt('serializes SCSS arithmetic as Expression(Operation)', () => {
    ...
    expect(serializeTypes(tree)).toContainString(`
      (Expression
        value:
          (Operation
    `);
    expect(firstRuleDeclValue(tree)?.value?.operator ?? firstRuleDeclValue(tree)?.node?.operator).toBe('+');
  });

  functionalIt('serializes isolated parenthesized slash division as Expression(Operation)', () => {
  ...
  functionalIt('keeps paren list slash forms as grouped values, not arithmetic expressions', () => {
  ...
  functionalIt('serializes nested property declarations as a Collection-valued declaration', () => {
  ...
  functionalIt('serializes nested property declarations with a base value as Sequence(..., Collection)', () => {
  ...
  functionalIt('serializes map.get() desugaring without literal map.get', () => {
  ...
  functionalIt('serializes @content rewrite', () => {
  ...
  functionalIt('serializes @content($color, $count) with call args', () => {
  ...
  functionalIt('serializes bare @include foo; as a mixin call', () => {
  ...
  functionalIt('serializes bare @include ns.foo; as a module-qualified mixin call', () => {
    ...
    expect(serialized).toContain(`'ns'`);
    expect(serialized).toContain(`'foo'`);
  });

  functionalIt('serializes @include keyword args', () => {
  ...
  functionalIt('serializes SCSS suffix rest params and spread args', () => {
  ...
  functionalIt('serializes SCSS literal spread args', () => {
  ...
  functionalIt('serializes plain CSS @import url(...) as an AtRule', () => {
  ...
  functionalIt('serializes placeholder rulesets', () => {
  ...
  functionalIt('serializes @if $a == $b as a Condition using =', () => {
    ...
    expect(trimmedStylesheet(tree)).toContain('=');
  ...
  functionalIt('serializes @use "sass:map" rewrite as JsImport "#sass/map"', () => {
  ...
  functionalIt('serializes legacy Sass @import "foo" as StyleImport(type=import, multiple=true)', () => {
  ...
  functionalIt('serializes comma-separated Sass imports as separate StyleImport nodes', () => {
  ...
  functionalIt('serializes @forward "foo" as StyleImport with forward', () => {
  ...
  functionalIt('serializes @forward "foo" as bar-* with forwardAsPrefix', () => {
  ...
  functionalIt('serializes @forward "foo" show/hide lists', () => {
    const { tree, errors, lexerResult } = parser.parse(`
  ...
  functionalIt('serializes @forward "foo" with(...) as StyleImport with injected vars', () => {
  ...
  functionalIt('serializes @use with(...) config var flags (!default, !global)', () => {
  ...
  functionalIt('serializes @extend .b inside a ruleset as an Extend node', () => {
  ...
  functionalIt('serializes @at-root selector shorthand as a hoisted ruleset', () => {
  ...
  functionalIt('serializes ns.$var as Reference(target=Reference)', () => {
  ...
  functionalIt('serializes ns.fn($x) as Expression(Call(name=Reference(target=Reference)))', () => {
  ...
  functionalIt('serializes plain fn($x) as Call(name=Reference(type=function,fallbackValue:true)) (no Expression)', () => {
  ...
  functionalIt('serializes @include ns.foo($x) as Call(name=Reference(target=Reference))', () => {
  ...
  functionalIt('serializes @use "foo" as bar with options.namespace=bar', () => {
  ...
  functionalIt('serializes @use "foo" as * with options.namespace=*', () => {
  ...
  functionalIt('serializes ns.\\#foo($x) as Expression(Call(name=Reference(type=mixin-ruleset)))', () => {
  ...
  functionalIt('serializes @debug, @warn, @error as Log nodes with correct level', () => {
    const { tree, errors, lexerResult } = parser.parse(`
      @debug "Debug message";
