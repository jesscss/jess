...
export const scssAstGrammar: Record<keyof ScssAstRules, FusedRule> = composeLeaf([cssAstSyntax, opaqueAtRuleRecognition, cssAstPseudoSyntax, rules<ScssAstRules>(
   ...
   */
    ...
    const DirectScssPseudo = choice(
       ...
       */
        sequence(
          pseudoColon,
          directScssGlobalLocalPseudoNameWithArgument,
          literal('('),
          g.DirectScssStaticSelectorPseudoArgument,
          literal(')')
        ),
       ...
       */
        sequence(
          ...
          not(directScssGlobalLocalPseudoNameWithArgument),
          g.CssAstSyntaxKeyword,
          optional(sequence(
            literal('('),
