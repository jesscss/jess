...
const cases = [
  ...
  ['root function call without root output', 'e("");', 'eval/root-call-without-root'],

  // Ledger P37: a bare call to no function raises rather than being written out.
  ['root call to an unresolved function', 'func();', 'eval/unresolved-call-statement'],
