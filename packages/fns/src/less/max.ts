...
export default defineFunction(
  ...
  function(this: any, ...input: Node[]) {
    ...
    syncLog({
      ...
      runId: 'minmax-debug',
      hypothesisId: 'HMM1',
      location: 'packages/fns/src/less/max.ts:entry',
      message: 'max called',
      data: {
    ...
    for (let i = 0; i < args.length; i++) {
      ...
      if (!(current instanceof Dimension)) {
        ...
        syncLog({
          ...
          runId: 'minmax-debug',
          hypothesisId: 'HMM2',
          location: 'packages/fns/src/less/max.ts:incompatibleType',
          message: 'max incompatible type',
    ...
    syncLog({
      ...
      runId: 'minmax-debug',
      hypothesisId: 'HMM3',
      location: 'packages/fns/src/less/max.ts:fallbackAny',
      message: 'max returned fallback any',
      data: {
