...
This document inventories the current `@jesscss/parser` scanner-first code and
maps each piece back to [requirements-and-scope.md](requirements-and-scope.md).
...
The main direction is code -> requirement. The requirement-to-code section later
in this file is only a secondary index.
...
| Current surface | Claimed purpose | Current verdict | Required action before blessing |
| --- | --- | --- | --- |
...
That is current allocation accounting for the generic parser package, not a
