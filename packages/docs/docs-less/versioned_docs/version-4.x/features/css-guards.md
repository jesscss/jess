---
title: "CSS Guards"
slug: "/features/css-guards"
audiences:
  - less
origin: less
---
:::info
CSS Guards are effectively `if` conditions around selectors.
:::

Released in [v1.5.0](https://github.com/less/less.js/blob/master/CHANGELOG.md).
