...
slug: "/features/detached-rulesets"
audiences:
  - less
origin: less
---
...
Parentheses after a detached ruleset call are mandatory (except when followed by a [lookup value](#property--variable-accessors)). The call `@detached-ruleset;` would not work.
...
You can even take advantage of [media query bubbling](./nested#nested-media-queries), for instance
...
_Note: unlocking variables into scope via a called mixin is deprecated. Use [property / variable accessors](#property--variable-accessors)._
