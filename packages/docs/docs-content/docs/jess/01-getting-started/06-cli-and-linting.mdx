...
| `vendor-prefix` | `lint/vendor-prefix` | CSS vendor-prefixed declarations without the standard property |
| `compatible-vendor-prefixes` | `lint/compatible-vendor-prefixes` | Opt-in incomplete CSS vendor-prefixed declaration sets |
