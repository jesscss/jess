...
This section refers to functions defined in stylesheets. Imports from other
languages use the planned `@-use` and `@-from` at-rules; see their
[current status](./atrules#-use-and--from).
