...
Sass-parity is **not** the goal here. **Valid CSS is the reference.** "But Sass accepts it" is not an argument for Sass+ accepting it — if the input is invalid CSS, Sass shouldn't have accepted it either, and Sass+ won't.
