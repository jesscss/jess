...
By design, a collection sits in a perfect syntax space between a JS object and a set of CSS rules. This is explained in the [Namespaces, collections, and maps](/docs/Language/namespaces-collections-maps) section.
