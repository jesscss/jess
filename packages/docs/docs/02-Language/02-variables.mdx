...
In most cases, you shouldn't need this feature, unless you're changing the value of a variable after setting within access to the same scope. However, it's useful for some cases, and necessary for supporting Sass's variable lookup behavior.
