...
export const selectorMap = Symbol('selectorMap');
...
export const mixinArgs = Symbol('mixinArgs');
export const noMatch = Symbol('noMatch');
export const isMixin = Symbol('isMixin');
export const protectedScopes = Symbol('protectedScopes');
export const shadowScopes = Symbol('shadowScopes');